...
*/
// Yes. I did use the and (&&) logical operator. A logical operator is used to
// perform logical operations on the value, usually they are used with comparison
// operators. That basically means that you can combine 2 or more comparisons to
//  obtain a true or false result that allows you to trigger an action.
