...
/* My solution did include a logical operator! However, I think that I would want
to change it to include a final condition, that if the cupsOfFlour was greater than 3,
and hasSauce was true, then it would still log that you can make pizza! */
