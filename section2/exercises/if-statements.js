...
if (dogAge <= 2) {
  console.log("Wow! It's a PUPPY!");
} else if (dogAge >= 10) {
  console.log("Sorry Old Yeller, it's that part of the movie... ELDERLY!")
} else {
  console.log("That certainly is a dog of some indeterminate middle age. ADULT!")
}
