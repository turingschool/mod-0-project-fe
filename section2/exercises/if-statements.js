...
if (dogAge <= 2) {
  console.log("Awww that little guy's a puppy");
} else if (dogAge >= 10) {
  console.log("That's an old dog but I bet he could still learn new tricks.");
} else {
  console.log("That's an adult dog. Please dress him up in a little business suit. That's not an adult dog thing I just think it'd be fun.");
}
