...
for yourself!
I used the && (and) operator to check if both of the conditions were true.
If we wanted to check if it was one or the other, we could have used the || (or) operator.
*/
