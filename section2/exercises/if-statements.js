...
if (dogAge <= 2) {
  ...
  console.log("The dog is still young at heart.");
} else {
  console.log("Poor doggy needs a cane.");
}
...
My solution did use a logical operator, in JavaScript logical operators are usually
