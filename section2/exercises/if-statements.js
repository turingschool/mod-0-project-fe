...
// If the dogAge is <= to 2, puppy. Likewise, 10 and oler is an elderly dog. Finally, everything else (3-9) is an adult
...
for yourself!
// Yes, I use the logical operator && (AND)! It worked, after I removed an extra set of
// parentheses that I enclosed the comparisons with; it didn't need them.
*/
