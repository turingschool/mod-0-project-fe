...
And another where you make a dash for the next room. The code will run one of these scenarios based on which condition
fits your answer.If you chose option 1, the first scenario would run. If you chose option 2, a different second
scenario would run. If you chose option 3,a third different scenario would run. The code decides what scenario to
run based on the number chosen and which condition leads to a "true" outcome. Because the variable bearChoice is equal
to one as defined on line 10, the console will log"You offer the bear your hat and the bear shows you a secret passage out!"
...
Its between "You offer the bear your hat and the bear shows you a secret passage out!" and
