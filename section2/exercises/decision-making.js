...
If the doorChoice is equal to one, the condition will evaluate to true and the bearClothing
will be assigned to hat. If the doorChoice is not equal to one, then the condition is false and the
bearClothing choice will be assigned to scarf.

2. What variable has a new value assigned to it after the first if statement executes?

The bearClothing variable has a new value to it after the first statement executes.

3. If you changed the variable doorChoice to equal 3, what would the bearClothing value be?

If I changed the variable doorChoice to equal 3, the condition would be false (3 is not equal to 1),
so the else code block would execute and the bearClothing value would be "scarf".
...
If I changed the variable doorChoice to equal 1, then the bearClothing will be 'hat.' And if the variable bearChoice
is equal to 2, then the 1st else if condiitonal statement will run true and the line printed will be
