...
//The if conditiona1 means block of code executes if condition1 is true. Condition1 is asking if the door choice is the same exact value on the
  // right (making the condition1 true) than the bearClothing will be hat.
  // else -> (block of code executes if the condition above evaluates as false). This means if the door choice is not the same exact value as the
  // value on the right, (making the condition1 false) than the bearClothing will be scarf.
...
//If the bearChoice is the same exact value as 1 than the code will print out "You offer the bear your " + bearClothing + " and the bear shows you a secret passage out!";
  ...
  //If none of the above conditions evaluate to true than the code will print out "You stay with the bear and become it's best friend!";
