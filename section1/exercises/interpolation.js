...
// Your answer and explanation here: A string will come out, saying 'My zoo has 7 unicorns'
...
// Declare three variables, name/content/data type of your choice. Think carefully about what
  ...
  var game = "football game";
  var minutes = 30
  console.log(`The family ordered ${numberOfPizzas} pizzas ${minutes} before the ${game}`);
