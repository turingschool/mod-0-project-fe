...
// Your answer and explanation here:
 //String / statement due to being enclosed in back-ticks.
...
var speedySlow = (`The ${speedy} jumped over the ${slowPoke}`)
console.log(speedySlow);
...
slowPoke = "tortoise";
speedy = "hare";
speedySlow = (`In a predictable result, the ${slowPoke} beat the ${speedy}`)
