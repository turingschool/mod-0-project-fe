...
console.log("The interpolation puts the variables together in a string and i have to rember to put a spaces so everything prints correctly.");
...
var eyeWear = "glasses";
var eyeColor = "brown";
console.log(`I have ${hairLength} hair and I wear ${eyeWear} to compliment my ${eyeColor} eyes.`);
