...
// The string data type will be logged to the console because when two different data
// types are used JavaScript coerces it to be string.
// YOU DO:
...
console.log(`${eat} no evil, ${pray} no evil, ${love} no evil`);
//-------------------
// FINAL CHECK
//-------------------
