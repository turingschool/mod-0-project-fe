...
// Your answer and explanation here:
   // The data types that will be logged in the console are `Number` since 7 is a number
   // and `string` since "unicorns" is closed off with quotes.
...
console.log(`${name} can type ${fast} ${type} per minute!`);
//-------------------
// FINAL CHECK
//-------------------
