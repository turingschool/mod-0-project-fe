...
var favoriteCity = "Istanbul";
var favoriteSeason = "Fall";
var randomNumOfWeeks = 4;

console.log(`I love ${favoriteCity} in the ${favoriteSeason} so much, I wish I could spend ${randomNumOfWeeks} weeks there!`);
