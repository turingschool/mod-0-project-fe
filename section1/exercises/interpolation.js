...
console.log("It will be a string with the variables injected into the sentence.");
...
var drink = "Zevia"
var place = "grocery store"
var benefit = "zero calorie"

console.log(`${drink} is a yummy ${benefit} soda drink sold at your local ${place}!`);
