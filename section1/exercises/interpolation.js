...
The interpolated var names in the console.log() are pulling the data from the
declared variables.*/
...
var numberOfPuzzles = 3;
var whereThePuzzlesAt = "on the walls";
var location = "office"

console.log(`I have ${numberOfPuzzles} puzzles hanging up ${whereThePuzzlesAt} of my ${location}.`)
