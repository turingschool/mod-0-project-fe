...
// A string will be logged.  Interpolation simply adds variables inside the string.
...
console.log(`My husband ${name} loves to eat ${food}. He can easily eat ${amount} for breakfast!`)
