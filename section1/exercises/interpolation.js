...
/* The console will log a string. Javascript will use type coercion to convert
...
var hometown = "Atlanta";
var currentTown = "Boston";
var yearsLived = 5;
console.log(`I'm originally from ${hometown}, but I live in ${currentTown} now. I've lived here for ${yearsLived} years.`);
