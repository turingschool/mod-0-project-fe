...
// Your answer and explanation here: ${numberOfCreatures} will output a number: 7 and ${creatures} will output the string: unicorns to form the sentence "My zoo has 7 unicorns".
...
console.log(`Asking ${inquiry} is ${emotion} but I should ask them in SLACK just in case my ${otherPeople} are struggling with similar problems.`);
//-------------------
// FINAL CHECK
//-------------------
