...
// It will log My zoo has 7 unicorns! And I think the reason why it works is because the number was listed first followed by the string
...
console.log(`Hopefully ${name} starts ${school} in ${month}!`);
