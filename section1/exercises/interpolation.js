...
//a string data type, because, even though it's using interpolation, it's wihin matching single quotation marks
...
var name = "Miranda Priestly"
var amount = 0
var flower = "Freesias"

console.log(`${name} was very clear that she wanted to see ${amount} ${flower}`)
