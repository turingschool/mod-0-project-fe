...
/* "My zoo has 7 unicorns!" will be displayed in the console. The string of
"My zoo has" will be concatenated with the value of `numberOfCreatures` then the value
of `creatures`.*/
