...
// Declare three variables, name/content/data type of your choice. Think carefully about what
  ...
  var technicalWalker = "hiker"
  var destination = "lake"
  var home = "camp"

console.log("After a long slog uphill the " + technicalWalker + " made it to the " + destination + " and set up their " + home);
