...
// My zoo has 7 unicorns!  Strings and concatenation are the data types that are used.  We are using concatenation
...
console.log("In a predictable result, the " + slowPoke + " beats the " + speedy + "!")
