...
/* "My zoo has 7 unicorns!" will be logged to the console.
 This is because the var names in the console.log() are pulling the assigned values
 from the defined variables and concantenating these valuse along with the string
 data typed into the console.log().*/
