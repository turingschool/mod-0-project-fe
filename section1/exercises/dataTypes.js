...
console.log('99 bottles of Coke on the wall');
// YOU DO: Write code below to log one line from your favorite song or movie:
console.log('In a book, in a box, high upon a shelf, in a locked and guarded vault, Are the things I keep only for my self, I have saved the rest for you.');
