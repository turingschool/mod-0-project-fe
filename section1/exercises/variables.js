...
var firstName = 'Masaki';
var isHungry = true;
var numberOfPets = 0;
// IN WORDS:
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
//The first one was a name so I used a string since it is text.
//The Second one I was not quite as sure on. But I think it's a Boolean since it is a yes or no.
//The third one was a number, because number of pets.
