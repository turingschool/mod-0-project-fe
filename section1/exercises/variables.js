...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
  //I chose to use string for the first one because it contained a series of charaters.
  // I chose BooLean for the secound because I am either hungry or not so true fasle works.
  //I choose number for the third because it is a number of pets you are representing.
