...
// log that variable to the console.
var voldemort = "Harry Potter must not return to Hogwarts!";
...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
// The first is a string since it is a string of characters. The second is a boolean since isHungry
// is a yes or no question. The third is a number since we are worried about the amount of pets.
