...
// log that variable to the console.
var hogwartsReturn = "Harry Potter must not return to Hogwarts!";
...
//`firstName` is a string since it is made entirely of letters.
//`isHungry` is a Boolean since it's a binary yes or no.
//`numberOfPets` is purely a number so it is (surprise!) a number.

// YOU DO:
// Re-assign the values to the three variables from the previous challenge to different
  // values (but same data type).
// log all three variables to the console.
firstName = "Gertrudius"
console.log(firstName)
isHungry = "True"
console.log(isHungry)
numberOfPets = 666666
