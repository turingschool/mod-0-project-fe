...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
// I decided to use string for the first variable because it involves words, not numbers or a true or false response like boolean. I chose boolean for the second variable because it is either true or false, and I chose numbers for the last variable because the response is just a number without any words or special characters.
