...
// log that variable to the console.
var hogwartsAnnouncement = name + " must not return to Hogwarts";
console.log(hogwartsAnnouncement);
...
// How did you decide to use the data type you did for each of the three variables above?
  // firstName is a sting or letters; isHungry is Boolean; numberOfPets is an integer.
