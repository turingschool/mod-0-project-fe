...
// How did you decide to use the data type you did for each of the three variables above?
  /* I used a string for the first variable, my name. I then used a boolean for
  the second variable to show that it is true, and I used a number for the third
  variable to show that I have 2 pets */
