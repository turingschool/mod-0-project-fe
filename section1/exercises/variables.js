...
// log that variable to the console.
var harryMustNot = "Harry Potter must not return to Hogwarts!"
console.log(harryMustNot);
...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
console.log("It seems that firstName and isHungry are string types, so that's what I decided on. However, numberOfPets seemed it should be a number data type, so I used that instead.")
