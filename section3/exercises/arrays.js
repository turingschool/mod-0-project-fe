...
var turtleFood =["apple","orange","banana","pear"]

// YOU DO: Write code below that will log the number of elements in the array of
// foods from above.
console.log(turtleFood.length);

// YOU DO: Write code below that uses a method to add "broccoli" to the foods array and
// log the changed array to verify "broccoli" has been added
turtleFood.push("broccoli");
console.log(turtleFood);
...
turtleFood.push("lettuce, tomatos, grapes");
console.log(turtleFood);
...
// 1: Instagram All your posts could be organized in an array.
// 2: NHL APP All the team names list could be stored in an array.
// 3: Check out of online clothing stores. All different sizes and colors could be arrays.
