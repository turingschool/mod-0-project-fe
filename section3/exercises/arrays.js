...
var foods = ["bread", "milk", "pasta", "coffee"];
...
foods.push("bananas", "brownies", "chips");
...
// 1: Amazon has lists where you can store items you want to buy under different names (wish list)
// 2: Any climbing log app that stores climbs that you have done (tension app)
// 3: The Udisc app stores the rounds that you have had over time in a list.
