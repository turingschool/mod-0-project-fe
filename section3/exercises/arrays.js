...
var foods = ["Pizza","Cookies","Ice Cream","Chips"];
...
foods.splice(2,0,"Cabbage","Brussle Sprouts","Spinach");
console.log(foods);
...
// Im thinking of the discord communication app in the main text channel of a server. It's almost similiar
// to slack in the way things are formatted. This array list will be for the main chat channel of my server
// 1: Embedded Youtube video link for a game someone is recommending.
// 2: Old photo posted of a friend to jokingly embarress him. Yearbook photo.
// 3: Series of text comments indiacting when people should hop on to play games.
