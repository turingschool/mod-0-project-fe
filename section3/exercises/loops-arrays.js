...
var foods = ["salad", "corn", "fries", "fried chicken"];
...
for (var i = 0; i < ages.length; i++) { //I want to iterate through the elements in ages
  //I want to set 2 conditions that will log out different messages when their condition is met
  if (ages[i] < 18) { 
