...
var foods = ["Mayonnaise", "Bread", "Bananas"]
...
/*
First, make a for loop that iterates over all the ages one at a time
Then, once you're inside the loop, use an if statement to check if the age is less than 18. IF it is, log the negative message.
If it isn't, log the affirmative message.
