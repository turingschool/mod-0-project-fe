...
var foods = ["Quinoa" , "Kale" , "Squash" , "Broccoli" , "Tomatoes"];
...
for (var i = 0; i < numbers.length; i++) {
  console.log(numbers[i], "doubled is", 2 * numbers[i]);
}
...
for (var i = 0; i < names.length; i++) {
  if (ages[i] < 18)
    console.log("Under 18? Oh no, you can't vote quite yet.", ages[i]);
  else
      console.log("18 or over? Make sure you get out and vote!", ages[i]);
    }
