...
var animalsArray = ["Monkey", "Guinea Pig", "Cat", "Dog"];

for (var i = 0; i < animals.length; i++){
  console.log("The",animalsArray[i],"is awesome!");
}


// YOU DO: Create an array of foods and then iterate over that array to log "Add
// <food> to shopping list" for each food item.
var foods = ["Fries","Burgers","Shakes","Hotdogs"]
...
for(var i = 0; i < names.length; i++){
  if (i > 1) console.log("Happy Birthday",names[i])
}
...
for(var i = 0; i < ages.length; i++){
  if (ages[i] >= 18) console.log("18 or over? Make sure you get out and vote!");
else if (ages[i] < 18)console.log("Under 18? Oh no, you can't vote quite yet.")
  }
