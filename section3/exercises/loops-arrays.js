...
var animalList = ["Dolphin", "Gorilla", "Peacock", "Chimpanzee", "Bald Eagle"];
...
var shoppingList = ["apples", "chicken", "pizza"];
...
var theNumbers = [2, 4, 7.5, 8, 11.5, 21];

for (var i = 0; i < theNumbers.length; i++){
  console.log(theNumbers[i] * 2);
  }
