...
for (var togo = 0; togo < ages.length; togo++) {
if ( ages[togo] < 18 ){
console.log(ages[togo] + " Oh no, you can't vote quite yet.");
}else {
console.log(ages[togo] + " Make sure you get out and vote!");
}}
