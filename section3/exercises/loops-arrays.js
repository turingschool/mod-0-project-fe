...
var foods = ['Lemon' , 'Biscuit' , 'Chowder' , 'Souffle' , 'Bisque']
...
//crashed my terminal with `numbers.length` without the `i <` in the condition section LMAO
...
// we have an array, an if then conditional, and a loop

//got it right basically on my first try! all i had to do was change the =< to
// a < to make sure 18 was included in the voting population!
