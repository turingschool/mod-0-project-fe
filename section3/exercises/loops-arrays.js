...
var foods = ["Ramen", "Bok Choy", "Cilantro", "Limes", "Green Onions", "Chili Paste", "Eggs"];

for (var i = 0; i < foods.length; i++) {
  console.log("Add " + (foods[i]) + " to shopping list: Ramen time!!!");
}
...
// THE FINAL YOU DO: Using the array of ages below,
// print out a statement for each age.
