...
var foods = ["Salmon", "Chicken", "Burrito", "Kale"]

foods.forEach(food => console.log(`Add ${food} to shopping list.`))
...
for (var i = 0; i < ages.length; i++) {
  var canYouVote
  if (ages[i] <18){
    canYouVote = "Oh no, you can't vote quite yet."
  }
  else {
    canYouVote = "Make sure you get out and vote!"
  }
