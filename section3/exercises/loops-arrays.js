...
animals.forEach((animals, i) => {console.log("The" + " " + animals
...
var moreFoods = ["Bread" , "Cheese" , "Cilantro" , "Bacon"];
moreFoods.forEach((moreFoods, i) => {console.log("Add " + moreFoods + " to shopping list")
...
for (var i = 0; i < ages.length; i++) {
 if (ages[i] >= 18) {console.log ([ages[i]]  + " Make sure you get out and vote!")
} else  (
