...
for (var i = 0; i < animals.length; i++) {console.log(`The ${animals[i]} is awesome!`);}
...
var numbers = [1, 2, 3, 4];
for (var i = 0; i < 4; i++) {console.log(numbers[i]*2);}
...
for (var i = 0; i < 5; i++) {console.log(`Happy Birthday ${names[i + 2]}!`);}
...
for (var i = 0; i < ages.length; i++) {
  if (ages[i] >= 18) {console.log(ages[i] + ' Make sure you go out and vote!');}
  else {console.log(ages[i] + ' Oh no, cant quite vote yet.');}
}

//WOOOOOOOOOOOOO!!!!! FINALLY GOT IT
