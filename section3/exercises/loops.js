...
// // The "i" variable is starting at the number zero, the condition is telling the loop to continue
// as long as the number is less than 3, every time the loop continues the update statement
// is telling the "i" variable to increase by one. The expected output is: 0, 1, 2
