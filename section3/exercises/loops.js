...
// EXPLAIN:
// 0, 1, 2 will be logged to the console because i starts at 0, and then is
// incremented by 1 two times.  So we have 0, 0+1=1, and 1+1=2.
...
for (var i = 0; i < 7; i++) {
 ...
 // 10 times.
for (var i = 0; i < 10; i++) {
  console.log("She sells seashells down the by seashore")
}
