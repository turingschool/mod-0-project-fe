...
// EXPLAIN:
/* The console logs the values 0, 1, and 2. The loop is initialized at 0, so it begins counting there.
The loop will run as long as i is less than 3, so 3 is not logged to the console.
*/
