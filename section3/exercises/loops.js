...
// The console logs the index of the array because the value of 'i' is set to 0
// 0 being the first index of the array
...
for (var i = 0; i < loopNum.length; i++) {
  console.log("This is loop number: " + loopNum[i]);
}
