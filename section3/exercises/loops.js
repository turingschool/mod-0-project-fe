...
// it will log 0, 1, 2. Its telling the code to loop continuously until I reaches 3, and in each iteration/loop, I increases by 1.
 ...
 // 10 times.
 for (var i = 0; i < 10; i++) {
   console.log("She sells seasells by the seashore");
 }
