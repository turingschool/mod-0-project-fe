...
// EXPLAIN: The numbers 0,1,2. This is because many programing languages start at
// 0. So when the console prints out the information it will start counting at 0.
...
for (var i = 0; i < 7; i++){
 ...
 // 10 times.
for (var i = 0; i < 10; i++){
  console.log("She sells seashsells down by the seashore");
}
