...
// EXPLAIN:
/* The terminal log counted up from the integer 0 to the integer 2 and ended.
It took the value of 'i' which is '0' and added 1 '++'. The loop had a conditional
where as it would not continue past the value of 3.
*/


 // YOU DO: Write code below that logs to the console, the sum of 2 plus 2, 7 times:
for (var i = 0; i < 7; i++) {
  console.log("the sum of 2 plus 2");
}
