...
// EXPLAIN:
// `0, 1, 2` is logged to the console. The variable 'i' was initialized to 0 and an increment
//operator (++) was used to add 1 to the value each time it is run, until it is run 3 times (i < 3)
