...
//The variable `i` is logged, `var i = 0` serves as the counter for the `for` loop,
//therefore when this counter loop runs 3 times, the outputs are:
//0
//1
//2
...
//Got this one to work without looking anything up! This is so fun!!!
for (var i = 10; i >= 0; i--)
console.log(i)
