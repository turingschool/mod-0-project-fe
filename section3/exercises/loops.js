...
// EXPLAIN: Console logs 0, 1, and 2. where `i` is declared as `0`, and `i` is less then `3` than `i < 3;` is declared as `true`, `i++` adds an iteration until reaching the `3` iteration causing `i < 3;` to become `false`
