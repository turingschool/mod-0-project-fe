...
// EXPLAIN:
/* In the second example, numbers 0, 1, & 2 are logged to the console (individually),
because we're telling the console to log the value of "i" in single incrememnts
...
/* You can also console.log(i, sum); so you can visibly see the number of times it's looping. */
//or like this:
// for (var i = 1; i <= 7; i++) {
//   console.log((2 + 2));
// }
