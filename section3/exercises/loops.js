...
// EXPLAIN:
// The loop is logging the current loop increment since the variable "i" is assigned a value of zero
// and the console is logging each loop iteration of the increment operator.
