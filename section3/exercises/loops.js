...
// EXPLAIN: 0, 1, 2 is logged to the console. This is logged to the console because a for loop runs until it is false. 0<3, 1<3, 2<3 3 is not <3 so the loop stops.
