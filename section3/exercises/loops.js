...
// EXPLAIN:
      // The numbers `0`, `1`, and `2` are logged to the console. This is because the loop defines
      // the variable `i` as any number that is equal to `0` but less than `3` and what is logged
      // to the console is the variable `i`.
...
var string = ('This is loop numnber: ');
