...
* So far my estimates have matched up fairly well with how long it's taken me to do work. The project has taken less time than I expected.
...
* Generally, yes. I work with the goal of completing the project by sections, taking small breaks when I feel fatigued. Between each section I'll take a longer break so I come back fully refreshed.
...
* I work best in 3 hour intervals, taking small breaks regularly throughout. Between the three hour intervals I'll take long breaks so I stay refreshed. I don't really have a "system" to keep me accountable. I set out with a realistic goal to reach a certain point in my work, then once achieved, evaluate where I am at in my day and what still needs to be completed.
